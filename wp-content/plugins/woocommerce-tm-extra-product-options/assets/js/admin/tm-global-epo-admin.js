    ...
    $.tmEPOAdmin = {
        ...
        pre_element_logic_init: function(do_section){
            ...
            sections.each(function(i,section){
                ...
                options[section_id]=[];lkjsdfsdf[section_id]=[];
                ...
                fields.each(function(ii,field){                  
                    ...
                    if (name.length==1){
                        ...
                        options[section_id][field_index]='<option data-section="'+section_id+'" value="'+field_index+'">'+value+'</option>';
                        lkjsdfsdf[section_id][field_index]='<option data-section="'+section_id+'" value="'+field_index+'">'+value+'</option>';
        ...
        element_logic_init: function(el){
            ...
            if (section_to_find && section_id && logicobj[section_id] && logicobj[section_id].values[field_index]){
                ...
                delete options_pre[section_id][field_index];
            }
        ...
        if ($('.tm-settings-wrap').length>0){
            ...
            $(document).on("click.cpf", ".tm-mn-movetodir,.tm-mn-deldir,.tm-mn-delfile", function(e) {
                ...
                if (forminp_tm_html.length>0) {
                    ...
                    $this.prepend('<i class="tm-icon fa fa-refresh fa-spin"></i>');
