            ...
            'subscribe' =>
                ...
                array(
                    ...
                    array(
                        ...
                        'desc' => __( '<p>To view or edit the template, login to your SendinBlue online dashboard and go to Campaigns > SMTP Templates.</p>', 'wc_sendinblue' ),
                        'css'      => 'min-width:300px;',
                        'type'     => 'select',
                        'default'  => '',
                    ...
                    array(
                        ...
                        'desc'    => __( '<p>The default state for the opt-in checkbox.</p>', 'wc_sendinblue' ),
                        'css'      => 'min-width:300px;',
                        'default'  => 'Checked',
                        'type'     => 'select',
                        'options'  => array(
			...
			'sms_options' =>
				...
				array(
					...
					array(
						...
						'type'     => 'textarea',
                        'desc' => __( '<i>Number of SMS used: % &nbsp;&nbsp;&nbsp;Number of characters left: % &nbsp;&nbsp;&nbsp;Attention: a line break is counted as a single character. </i>', 'wc_sendinblue'),
