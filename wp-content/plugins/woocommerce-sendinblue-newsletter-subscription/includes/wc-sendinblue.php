    ...
    public static function init(){
        ...
        if (self::$access_key != '') {
            ...
            if ( !self::$lists ) {
                ...
                if(!isset(self::$customizations['ws_sendinblue_list'])) {
                    self::$customizations['ws_sendinblue_list'] = self::$lists['data'][0]['id'];
                    update_option('wc_sendinblue_settings', self::$customizations);
                }
                $list_data = array();
